...
from portal.models import Case, DICOMInstance, DICOMSet, ProcessingResult
...
class WorkJobView(View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            job = ProcessingResult.objects.get(id=request.GET["id"])
    ...
    @classmethod
    def do_job(cls, job: ProcessingResult):
    ...
    @classmethod
    def _do_job(cls,id):
        job = ProcessingResult.objects.get(id=id)
