...
def process_folder(incoming_case):
    ...
    try:
        ...
        for file_path in files_to_copy:
            ...
            shutil.move(file_path, dst_path)  # ./data/incoming/<Incoming_UID>/ => ./data/cases/<UID>/input/
    except Exception as e:
        print(f"Exception {e} during copying files from {incoming_case} to {input_dest_folder}")
        return False
